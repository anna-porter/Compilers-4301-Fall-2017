...
void ExecStmts()
{
   ...
   //*honors debug for stage0* Added "$" and "const" and ":" and "." and "var" and "ERROR" to fix stage0 coredump
	if(token != "end" && token != "until" && token != ")" && token != "$" && token != "const" && token != ":" && token != "." && token != "var" && token != "ERROR")
	{
		ExecStmts();
	}
}
...
bool IsKeyWord(string str)
{
   return (str == "program" || str == "begin" || str == "end" || str == "var" || str == "const" || str == "integer" || str == "boolean" || str == "true" || str == "false" || str == "not" || str == "mod" || str == "div" || str == "and" || str == "or" || str == "read" || str == "write" || str == "if" || str == "then" || str == "else" || str == "repeat" || str == "while" || str == "do" || str == "until");
}
